  ...
  <div class="card">
    <div class="card-header"> <h5 class="card-title">Plus d'information sur: {{ $product->name }}</h5></div>
    <div class="card-body">
          ...
          <h5 class="card-text">Photo :<img src="{{ asset('images/'. $product->photo) }}" height="100px"width="200px" alt="{{ $product->name }}"></h5>
          <h5 class="card-text">Prix : {{ $product->prix }}</h5>
          <h5 class="card-text">Description: {{ $product->description }}</h5>
          <h5 class="card-text">Collection: {{ $product->collection_id }}</h5>
          <h5 class="card-title">Créer le : {{ $product->created_at}}</h5>
          <h5 class="card-title">Modifier le : {{ $product->updated_at}}</h5>
    </div>
