...
@section('contenu')
      ...
      <div class="Nosproduits">
        <h2 class="titreproduit">Les Colliers - Azrar</h2>
        <p>Collection de colliers kabyles pour femme en argent massif, ils vous apporterons  de l’originalité avec leurs <br> design typiquement kabyles de fabrication artisanale.</p>
