            ...
            <ul class="side-menu top">
                ...
                <li>
                    <a href="{{ url('users') }}">
                        ...
                        <span class="text">Listes utilisateurs</span></a>
                    </a>
                </li>
    ...
    <table class="table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a href="{{ url('/users/' . $user->id) }}" title="View Student"><button class="btn btn-info btn-sm"><i class="fa fa-eye" aria-hidden="true"></i> View</button></a>
